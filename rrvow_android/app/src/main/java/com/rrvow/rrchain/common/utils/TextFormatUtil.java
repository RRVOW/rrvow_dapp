...
public class TextFormatUtil {
    ...
    public static SpannableString formatPrice(String price, int unitSize) {
        SpannableString ss = new SpannableString(MessageFormat.format("{0}{1}", AppTools
                .getString(R.string.unit_money), price));
        ss.setSpan(new AbsoluteSizeSpan(unitSize), 0, 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        if (ss.toString().contains(".")) {
            ss.setSpan(new AbsoluteSizeSpan(unitSize), ss.toString().indexOf("."), ss.toString()
    ...
    public static SpannableString formatOldPrice(String price) {
        SpannableString ss = new SpannableString(MessageFormat.format("{0}{1}", AppTools
                .getString(R.string.unit_money), price));
        ss.setSpan(new AbsoluteSizeSpan(AppTools.getDimensionPixelSize(R.dimen
                .super_small_font_size)), 0, 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
