...
final class InertiaTimerTask extends TimerTask {
    ...
    public final void run() {
        ...
        if (!loopView.isLoop) {
            ...
            } else if (loopView.totalScrollY >= (int) ((float) (loopView.items.size() - 1 -
                    loopView.initPosition) * itemHeight)) {
                loopView.totalScrollY = (int) ((float) (loopView.items.size() - 1 - loopView
