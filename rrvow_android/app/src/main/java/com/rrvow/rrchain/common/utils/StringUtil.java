...
//    private static final String TAG = "StringUtil";
    ...
    public static String formatAmount(double scale) {
        DecimalFormat fnum = new DecimalFormat("##0.00");
        return fnum.format(scale);
    }
    ...
    public static String formatDNum(String num) {
        try {
            if ("0".equals(num)) return "0.0000";
            BigDecimal bg = new BigDecimal(parseDouble(num));
            return String.valueOf(bg.setScale(4,
