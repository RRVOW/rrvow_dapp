...
public class ProgressButtonLayout extends FrameLayout {
    ...
    public ProgressButtonLayout(@NonNull Context context, @Nullable AttributeSet attrs, int
            defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        coverResId = ta.getResourceId(R.styleable.ProgressButtonLayout_cover, R.drawable
                .ic_pbl_cover);
        ta.recycle();
    }
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (value == bw) {
                    ...
                    TranslateAnimation translateAnimation = new TranslateAnimation
                            (-translateDistance, translateDistance, 0, 0);
    ...
    public void showCover(final View rootView, int duration, final CoverCallback coverCallback) {
        ...
        ViewGroup.LayoutParams parentParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams
                .MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        parent.addView(coverLayout, parent.getChildCount(), parentParams);
        cover.setAlpha(1f);
        progress.setVisibility(View.INVISIBLE);
        button.setVisibility(View.INVISIBLE);
        cover.animate().setDuration(duration).scaleX(sh / pw * 4).scaleY(sh / ph * 4).alpha(1)
