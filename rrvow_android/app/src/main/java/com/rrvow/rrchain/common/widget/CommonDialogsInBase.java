...
public class CommonDialogsInBase {
    ...
    public void displayMsgWithOneBtnDialog(Activity context, String title, String msg, boolean
            cancelable, OnBtnClickL onBtnClickL) {
        displayMsgWithOneBtnDialog(context, title, msg, null, cancelable, onBtnClickL, null);
    }

    public void displayMsgWithOneBtnDialog(Activity context, String title, String msg,
                                           OnBtnClickL onBtnClickL, DialogInterface
     ...
     */
    public void displayMsgWithOneBtnDialog(Activity context, String title, String msg, String
            btnName, boolean cancelable,
                                           OnBtnClickL onBtnClickL, DialogInterface
                                                   .OnCancelListener onCancelListener) {
    ...
    public MaterialDialog displayTwoBtnDialog(Activity context, String title, String leftText,
                                              String rightText, String content,
                                              OnBtnClickL leftListener, OnBtnClickL rightListener) {
        return displayTwoBtnDialog(context, title, leftText, rightText, content, leftListener,
                rightListener, null);
    }
    ...
    public MaterialDialog displayTwoBtnDialog(Activity context, String title, String leftText,
                                              String
                                                      rightText, String content, OnBtnClickL
                                                      leftListener, OnBtnClickL rightListener,
