...
public class DisplayUtils {
    ...
    public static int getStatusBarHeight() {
        int height = 0;
        int resourceId = App.getContext().getResources().getIdentifier("status_bar_height",
                "dimen", "android");
        if (resourceId > 0) {
    ...
    public static int getActionBarHeight() {
        ...
        if (App.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            actionBarHeight = TypedValue.complexToDimensionPixelSize(tv.data, App.getContext()
                    .getResources()
                    .getDisplayMetrics());
        }
