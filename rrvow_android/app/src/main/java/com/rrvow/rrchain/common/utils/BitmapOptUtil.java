...
public class BitmapOptUtil {
     ...
     * @return 目标宽高的位图
     */
    public static Bitmap resizeBitmapByCenterCrop(Bitmap src, int containerWidth, int
            containerHeight) {
        ...
        return Bitmap.createBitmap(scaleUpBitmap, firstPixelX, firstPixelY, containerWidth,
                containerHeight);
    }
    ...
    public static Bitmap getReflectedBitmap(Bitmap mBitmap) {
        ...
        //Bitmap mInverseBitmap = Bitmap.createBitmap(mBitmap, 0, height/2, width, height/2,
        // matrix, false);
    ...
    public static Bitmap getAlphaBitmap(Bitmap mBitmap, int color) {
        ...
        Bitmap mAlphaBitmap = Bitmap.createBitmap(mBitmap.getWidth(), mBitmap.getHeight(), Config
                .ARGB_8888);
    ...
    public static Bitmap getRoundCornerBitmap(Bitmap mBitmap, float roundPx) {
        Bitmap bgBitmap = Bitmap.createBitmap(mBitmap.getWidth(), mBitmap.getHeight(), Config
                .ARGB_8888);
        //把创建的位图作为画板
    ...
    public static Bitmap getGrayBitmap(Bitmap mBitmap) {
        Bitmap mGrayBitmap = Bitmap.createBitmap(mBitmap.getWidth(), mBitmap.getHeight(), Config
                .ARGB_8888);
